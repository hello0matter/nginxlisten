...
- 生成时间: `2026-06-06T12:58:32.494725+08:00`
...
- `58.60.110.201` 分数 `30.0` 请求 `171` 峰值RPS `16` 路径数 `82` 原因 `burst, sensitive-path`
  重点路径: /nh_api/Approval/Project/GetProjectList(13), /nh_api/Approval/sys/GetDepartmentDiseasePageList(10), /nh_api/Approval/Apply/GetApprovalApplyList(9), /nh_api/HealthInstruction/SpecColumn/GetSpecColumnModuleGroup(6)
- `119.123.133.112` 分数 `30.0` 请求 `158` 峰值RPS `21` 路径数 `103` 原因 `burst, sensitive-path`
  重点路径: /nh_api/Survey/QuestionnaireManage/GetQuestSubjectsById(6), /nh_api/Survey/ExternalMedicalRecord/QueryAnswerCardIdByQParam(6), /nh_api/Survey/AnswerCard/GetAnswerCardById(6), /nh_api/Approval/Project/GetProjectList(5)
- `183.39.19.71` 分数 `30.0` 请求 `145` 峰值RPS `25` 路径数 `121` 原因 `burst, sensitive-path`
  重点路径: /nh_api/Survey/ExternalMedicalRecord/QueryAnswerCardIdByQParam(5), /nh_api/Survey/AnswerCard/GetAnswerCardById(5), /nh_approvalweb/css/index.css(4), /nh_approvalweb/css/basic.css(4)
- `223.104.86.78` 分数 `30.0` 请求 `142` 峰值RPS `21` 路径数 `107` 原因 `burst, sensitive-path`
  重点路径: /nh_api/auth/login/Authenticket(6), /nh_api/Approval/Apply/GetRejectListByPage(3), /nh_api/Approval/Apply/GetMyRejectListByPage(3), /nh_api/Approval/Apply/GetWaitApplyListByPage(3)
...
- `223.104.86.72` 分数 `30.0` 请求 `108` 峰值RPS `18` 路径数 `96` 原因 `burst, sensitive-path`
  重点路径: /nh_api/auth/login/Authenticket(3), /nh_api/Survey/QuestionnaireManage/GetQuestSubjectsById(3), /nh_api/Survey/ExternalMedicalRecord/QueryAnswerCardIdByQParam(3), /nh_api/Survey/AnswerCard/GetAnswerCardById(3)

## 待人工研判 IP

- 分层明细: [D:\tmp\anjian\pj\st\tmp\nginxlisten\output-ban-test\review_ips.csv](D:\tmp\anjian\pj\st\tmp\nginxlisten\output-ban-test\review_ips.csv)
- 高优先级研判: `120.234.61.168, 112.97.203.114, 219.133.80.154, 183.238.10.154, 223.160.224.36, 223.104.79.38, 43.247.70.12`
- 观察 IP: `113.84.194.100, 113.88.95.148, 112.97.81.121, 123.168.84.249, 113.84.65.63, 45.138.16.206, 223.104.79.67, 58.60.110.201, 119.123.133.112, 183.39.19.71, 223.104.86.78, 113.84.209.96, 223.104.86.72, 223.104.87.157, 223.104.79.103, 223.104.68.79, 183.17.53.247, 14.127.46.70, 163.125.144.200, 223.104.79.118`
...
- `/Home/GetWebSiteAddress` 分数 `31.32` 请求 `234` 源IP `30` 峰值RPS `3` 最大响应 `56`
  主要来源: 183.238.10.154(166), 43.247.70.12(30), 113.84.65.63(4), 183.17.53.247(3), 113.84.65.187(2)
- `/nh_api/Survey/ExternalMedicalRecord/QueryAnswerCardIdByQParam` 分数 `28.37` 请求 `110` 源IP `37` 峰值RPS `3` 最大响应 `324`
  主要来源: 223.160.224.36(15), 113.84.194.100(11), 223.104.87.157(6), 112.97.203.114(6), 119.123.133.112(6)
- `/nh_api/Survey/AnswerCard/GetAnswerCardById` 分数 `28.19` 请求 `105` 源IP `36` 峰值RPS `3` 最大响应 `6446`
  主要来源: 223.160.224.36(15), 113.84.194.100(12), 223.104.87.157(6), 119.123.133.112(6), 113.88.95.148(6)
- `/nh_api/HealthInstruction/sys/GetSystemInfo` 分数 `28.0` 请求 `100` 源IP `73` 峰值RPS `1` 最大响应 `778`
  主要来源: 112.97.203.114(8), 223.104.79.22(4), 183.238.10.154(3), 223.104.77.165(3), 223.104.77.171(3)
- `/nh_api/HealthInstruction/DataSummaryRecord/GetBasicDataSummary` 分数 `28.0` 请求 `100` 源IP `73` 峰值RPS `2` 最大响应 `214`
  主要来源: 112.97.203.114(8), 223.104.79.22(4), 183.238.10.154(3), 223.104.77.165(3), 223.104.77.171(3)
- `/nh_api/Approval/process/GetProcessStepForHandle` 分数 `18.0` 请求 `83` 源IP `16` 峰值RPS `2` 最大响应 `17102`
  主要来源: 183.238.10.154(56), 223.160.224.36(5), 113.84.194.100(3), 223.104.87.157(2), 123.168.84.249(2)
- `/nh_api/Approval/process/ProcessApply` 分数 `18.0` 请求 `74` 源IP `21` 峰值RPS `3` 最大响应 `1216`
  主要来源: 113.84.194.100(13), 112.97.203.114(10), 223.104.79.67(8), 120.234.61.168(6), 223.160.224.36(5)
- `/nh_api/Approval/Sys/SignPatient` 分数 `18.0` 请求 `74` 源IP `23` 峰值RPS `3` 最大响应 `344`
  主要来源: 112.97.203.114(18), 113.84.194.100(10), 120.234.61.168(8), 219.133.80.154(7), 58.60.110.201(5)
...
- `2026-06-03T14:53:43+08:00` `112.97.81.121` `/nh_img/Imgs/Original/Approval/369733db-9ebe-4333-bf90-a9691a609a4a.jpg` 状态 `200` 响应 `4292783` 原因 `large-response`
- `2026-06-04T16:49:47+08:00` `113.88.95.148` `/nh_img/Imgs/Original/Approval/7cb7a707-847e-4782-8ee9-0df82cb47ccf.jpg` 状态 `200` 响应 `4017114` 原因 `large-response`
- `2026-06-04T16:37:05+08:00` `113.88.95.148` `/nh_img/Imgs/Original/Approval/7cb7a707-847e-4782-8ee9-0df82cb47ccf.jpg` 状态 `200` 响应 `4017114` 原因 `large-response`
- `2026-06-03T14:53:44+08:00` `112.97.81.121` `/nh_img/Imgs/Original/Approval/cd33ba3f-9127-497a-9e9b-a994827322ae.jpg` 状态 `200` 响应 `3942620` 原因 `large-response`
- `2026-06-03T14:53:44+08:00` `112.97.81.121` `/nh_img/Imgs/Original/Approval/5921d61c-4067-4fdb-839f-cccd17c80825.jpg` 状态 `200` 响应 `3558865` 原因 `large-response`
- `2026-06-03T14:53:43+08:00` `112.97.81.121` `/nh_img/Imgs/Original/Approval/d65ec578-93e9-419c-92c6-83984d1d97a6.jpg` 状态 `200` 响应 `3554731` 原因 `large-response`
- `2026-06-03T14:53:44+08:00` `112.97.81.121` `/nh_img/Imgs/Original/Approval/1232f7f6-d9ad-493e-b5c8-86504cfb3cb9.jpg` 状态 `200` 响应 `3525016` 原因 `large-response`
...
### `/nh_api/HealthInstruction/sys/GetSystemInfo`

### `/nh_api/HealthInstruction/DataSummaryRecord/GetBasicDataSummary`

### `/nh_api/Approval/process/GetProcessStepForHandle`

### `/nh_api/Approval/process/ProcessApply`

### `/nh_api/Approval/Sys/SignPatient`
